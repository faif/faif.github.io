    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>Inferno</h2>'
         + '<p>Harvard professor of symbology Robert Langdon awakens in an Italian hospital, disoriented and with no recollection of the past thirty-six hours, including the origin of the macabre object hidden in his belongings.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/17212231-inferno" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
