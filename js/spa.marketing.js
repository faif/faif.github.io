    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>Origin</h2>'
         + '<p>Robert Langdon, Harvard professor of symbology and religious iconology, arrives at the ultramodern Guggenheim Museum in Bilbao to attend a major announcement—the unveiling of a discovery that “will change the face of science forever.”</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/32283133-origin" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
         + '<img class="img-circle" src="graphics/rtfm.png" alt="Technical reading" width="140" height="140">'
         + '<h2>Image and Video Processing</h2>'
         + '<p>In this course, you will learn the science behind how digital images and video are made, altered, stored, and used. We will look at the vast world of digital imaging...</p>'
         + '<p><a class="btn btn-default" href="https://www.coursera.org/learn/image-processing/home/info" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + '<p class="lead">The present: I am a Software Engineer with ~ 9 years of professional experience. I am passionate about programming and'
