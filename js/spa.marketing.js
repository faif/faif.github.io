    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>Tides of War</h2>'
         + '<p>Brilliant at war, a master of politics, and a charismatic lover, Alcibiades was Athens’ favorite son and the city’s greatest general. A prodigal follower of Socrates, he embodied both the best and the worst of the Golden Age of Greece...</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/1317.Tides_of_War" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
         ...
         + '<p>This course will introduce you to Amazon Web Services (AWS) core services and infrastructure. Through demonstrations you\'ll learn how to use and configure AWS services to deploy and host a cloud-native application...</p>'
         + '<p><a class="btn btn-default" href="https://www.coursera.org/learn/aws-fundamentals-going-cloud-native" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
