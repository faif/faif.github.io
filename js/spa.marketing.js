    ...
    configMap = {
     ...
     + '<div class="row">'
       ...
       + '<div class="col-lg-4">'
         ...
         + '<h2>Docker in Practice</h2>'
         + '<p>Docker is impossible to ignore. This lightweight container system is easier to deploy and more flexible than traditional VMs. Built for simplicity and speed, it radically reduces your reliance on manual system administration for'
         + ' tasks like configuring servers, creating disposable (and portable!) development environments, and predictably rolling out applications on unknown systems.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/25484084-docker-in-practice" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-10">'
         ...
         + '<p class="lead">The present: I am a Software Engineer with ~ 7 years of professional experience. I am passionate about programming and'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-10">'
         ...
         + '   <tr><td><a href="https://github.com/faif/python-patterns">python-patterns</a></td><td>A collection of design patterns/idioms in Python</td><td>Python, design patterns, programmer, maintainer</td></tr>'
         + '   <tr><td><a href="https://developer.mbed.org/users/faif/">mbed prototypes</a></td><td>Several microcontroller prototypes</td><td>C++, mbed, LPC1768, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/shell-utils">shell-utils</a></td><td>Useful functions for POSIX shells (bash, ksh, tcsh, etc.)</td><td>shell, scripting, POSIX, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/algo">algo</a></td><td>Implementation of common algorithms</td><td>programming, algorithms, programmer</td></tr>'
         + ' </table>'
         + '</div>'
         ...
         + ' <table class="table table-condensed table-hover">'
         + '   <th>Name</th><th>Summary</th><th>Keywords</th>'
         + '   <tr><td><a href="https://www.packtpub.com/application-development/mastering-python-design-patterns">Mastering Python Design Patterns</a></td><td>Improve your Python skills by implementing idiomatic design patterns</td><td>Python 3, design patterns, author</td></tr>'
         + '   <tr><td><a href="https://www.packtpub.com/application-development/mastering-object-oriented-python">Mastering Object-Oriented Python</a></td><td>Grasp the intricacies of object-oriented programming in Python</td><td>Python, object-oriented, reviewer</td></tr>'
         + '   <tr><td><a href="https://www.packtpub.com/application-development/learning-python-design-patterns">Learning Python Design Patterns</a></td><td>Introduction to design patterns using Python</td><td>Python, design patterns, reviewer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/Prodoku">Prodoku</a></td><td>A Sudoku solver</td><td>SWI-Prolog, CLP</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/EuroCitizen">EuroCitizen</a></td><td>A Web Ontology intended to describe European citizens</td><td>OWL, semantic web, protégé, pellet, author</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/montecarlo">montecarlo</a></td><td>Using the Monte Carlo methods in problem solving</td><td>Python, monte carlo, probabilities, programmer</td></tr>'
         + '   <tr><td><a href="http://www.creakyoldmemory.dadiugames.dk">Creaky Old Memory</a></td><td>A 3D puzzle game involving picture gathering and organ playing</td><td>Unity, C#, programmer</td></tr>'
         + '   <tr><td><a href="https://www.youtube.com/watch?v=osMFB-_Zmyk">Trail of the Collector</a></td><td>A 3D puzzle crime game</td><td>Unity, C#, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/expr-calc">expr-calc</a></td><td>A simple expression calculator</td><td>C++, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/quote">quote</a></td><td>Print a random quote from an input file</td><td>Python, motd, fortune, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/GraphNetwork">GraphNetwork</a></td><td>An applet for visualizing graph algorithms</td><td>Java, Swing, graphs, algorithms, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/nfiles-ndisks">nfiles-ndisks</a></td><td>Calculate the optimum number and size of files that can fit into the hard disk(s)</td><td>GAlib, C++, programmer</td></tr>'
         + '   <tr><td><a href="files/copy-on-write-based-file-systems.pdf">Copy On Write Based Filesystems</a></td><td>The report of my MSc thesis</td><td>ZFS, Btrfs, copy on write, author</td></tr>'
         + '   <tr><td><a href="http://savannah.gnu.org/projects/www-el/">www-el</a></td><td>Translating all the important gnu.org articles to the Greek language</td><td>GNU, Greek, moderator</td></tr>'
         + ' </table>'
         + '</div>'
         ...
         + ' <table class="table table-condensed table-hover">'
         + '   <th>Name</th><th>Summary</th><th>Keywords</th>'
         + '   <tr><td><a href="https://github.com/faif/ctci">Cracking the Coding Interview</a></td><td>Python solutions of the book using TDD</td><td>Python 3, TDD, problem solving, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/myicpc">myicpc</a></td><td>Solving the ACM ICPC problems</td><td>ACM, ICPC, problem solving, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/system-code">system-code</a></td><td>Code related with system programming</td><td>operating system, admin, programmer</td></tr>'
         + '   <tr><td><a href="https://github.com/faif/The-Crime-Tracer">The Crime Tracer</a></td><td>A 2D adventure crime game</td><td>Pygame, 2D, adventure, programmer</td></tr>'
         + ' </table>'
         + '</div>'
         + '<p class="pull-right"><a href="#top"><img src="graphics/top.png" alt="Back to top" width="32" height=32"></a></p>'
         + '<hr class="featurette-divider">'
