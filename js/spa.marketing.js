    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>The Prague Cemetery</h2>'
         + '<p>19th-century Europe—from Turin to Prague to Paris—abounds with the ghastly and the mysterious. Conspiracies rule history. Jesuits plot against Freemasons. Italian republicans strangle priests with their own intestines.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/10314376-the-prague-cemetery" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + '<p class="lead">The present: I am a Software Architect with ~ 11 years of professional experience as a Software Engineer. My main qualities are the ability to work independently,'
         + ' critical thinking, and fitting well into a team. My current interests are distributed systems and functional programming.</p>'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + ' message before sending any connection invitations.</p>'
            + '<p class="lead">I am also a fairly active <a href="https://x.com/SKasampalis">X</a> (former Twitter) user. Feel free to send'
         + ' me a private X message or just a tweet, but always take into account that nothing is really private on X...</p>'
