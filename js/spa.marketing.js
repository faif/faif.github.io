    ...
    configMap = {
     ...
     + '<div class="row">'
       ...
       + '<div class="col-lg-4">'
         ...
         + '<p>This practical guide provides the first comprehensive overview of software architecture\'s many aspects. You\'ll examine architectural characteristics, architectural patterns, component determination...</p>'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + '<p class="lead">The present: I am a Software Engineer with ~ 11 years of professional experience. I am passionate about programming and'
