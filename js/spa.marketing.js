    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>Fire in the Valley</h2>'
         + '<p>In the 1970s, while their contemporaries were protesting the computer as a tool of dehumanization and oppression, a motley collection of college dropouts, hippies, and electronics fanatics were engaged in something much more subversive.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/23803494-fire-in-the-valley" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
         + '<img class="img-circle" src="graphics/rtfm.png" alt="Technical reading" width="140" height="140">'
         + '<h2>Become an Algebra Master</h2>'
         + '<p>This 343-lesson course includes video and text explanations of everything from Algebra, and it includes more than 115 quizzes (with solutions!) to help you test your understanding along the way.</p>'
         + '<p><a class="btn btn-default" href="https://www.udemy.com/integralcalc-algebra/" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
