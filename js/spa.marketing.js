    ...
    configMap = {
     ...
     + '<div class="row">'
       ...
       + '<div class="col-lg-4">'
         ...
         + '<h2>Machine Learning A-Z</h2>'
         + '<p>Learn to create Machine Learning Algorithms in Python and R from two Data Science experts. Code templates included. We will walk you step-by-step into the World of Machine Learning.</p>'
         + '<p><a class="btn btn-default" href="https://www.udemy.com/machinelearning/learn/v4/overview" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
