    ...
    configMap = {
     ...
     + '<div class="row">'
       ...
       + '<div class="col-lg-4">'
         ...
         + '<h2>Classic Computer Science Problems in Swift</h2>'
         + '<p>Exploring foundational coding techniques and algorithms. As you work through examples in search, clustering, graphs, and more, you\'ll remember important things you\'ve forgotten and discover classic solutions to your "new" problems.</p>'
         + '<p><a class="btn btn-default" href="https://www.manning.com/books/classic-computer-science-problems-in-swift" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
