    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>The UNIX Haters Handbook</h2>'
         + '<p>In the tradition of 12-step programs that help people overcome their addictions by sharing stories, The UNIX-Haters Handbook is the self-help guide for people affected by the world\'s most esoteric and most widely used operating system.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/174904.The_UNIX_Hater_s_Handbook" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
         + '<img class="img-circle" src="graphics/rtfm.png" alt="Technical reading" width="140" height="140">'
         + '<h2>Grokking Algorithms</h2>'
         + '<p>An algorithm is nothing more than a step-by-step procedure for solving a problem. This fully-illustrated and engaging guide makes it easy for you to learn how to use algorithms effectively in your own programs.</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/22847284-grokking-algorithms-an-illustrated-guide-for-programmers-and-other-curio" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
