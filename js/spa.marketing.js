    ...
    configMap = {
     ...
     + '<div class="row">'
       + '<div class="col-lg-4">'
         ...
         + '<h2>The Name of the Rose</h2>'
         + '<p>The year is 1327. Benedictines in a wealthy Italian abbey are suspected of heresy, and Brother William of Baskerville arrives to investigate. When his delicate mission is suddenly overshadowed by seven bizarre deaths...</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/119073.The_Name_of_the_Rose" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
         + '<img class="img-circle" src="graphics/rtfm.png" alt="Technical reading" width="140" height="140">'
         + '<h2>Math for Programmers</h2>'
         + '<p>To score a job in data science, machine learning, computer graphics, and cryptography, you need to bring strong math skills to the party. Math for Programmers teaches the math you need for these hot careers, concentrating on what you need to know as a developer...</p>'
         + '<p><a class="btn btn-default" href="https://www.goodreads.com/book/show/45361265-math-for-programmers" role="button">View details &raquo;</a></p>'
       + '</div>'
       + '<div class="col-lg-4">'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + '<p class="lead">The present: I am a Software Engineer with ~ 10 years of professional experience. I am passionate about programming and'
     ...
     + '<div class="row featurette">'
       + '<div class="col-md-12">'
         ...
         + ' I\'m planning to read. Regarding magazines, <a href="http://hackermonthly.com">Hacker Monthly</a> was great but it\'s not published any longer. <a href="http://theprosegarden.com">PragPub</a> was great too but it\'s also over.'
