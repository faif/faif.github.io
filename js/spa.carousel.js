       ...
       + '<div class="item">'
         ...
         + '<div class="container">'
           + '<div class="carousel-caption">'
             ...
             + '<p>If you like traveling and taking photos check my collection on Flickr. Nothing special, but you might enjoy some of the photos. It is not full of cats and dogs, I promise :)</p>'
             + '<p><a class="btn btn-lg btn-primary" href="https://www.flickr.com/photos/freeasinfreedom/">Check my Flickr</a></p>'
           + '</div>'
         + '</div>'
       + '</div>'
       + '<div class="item">'
         ...
         + '<div class="container">'
           + '<div class="carousel-caption">'
             ...
             + '<p>πάντα ῥεῖ (everything flows) -- Heraclitus (535 - 475 BC)</p>'
             + '<p><a class="btn btn-lg btn-primary" href="https://en.wikipedia.org/wiki/Heraclitus#Panta_rhei.2C_.22everything_flows.22">About this quote</a></p>'
           + '</div>'
         + '</div>'
       + '</div>'       
