       ...
       + '<div class="item active">'
         ...
         + '<div class="container">'
           + '<div class="carousel-caption">'           
             ...
             + '<p>I am Sakis, a Software Architect living in The Netherlands. I like functional programming (mainly Clojure) and high-level'
             + ' languages (think of Python and Prolog) but if a project requires it I can also work with more verbose languages (e.g. C++, Java)</p>'
