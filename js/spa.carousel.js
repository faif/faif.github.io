    ...
    configMap = {
     ...
     + '<div class="carousel-inner" role="listbox">'
       ...
       + '<div class="item">'
         ...
         + '<div class="container">'
           + '<div class="carousel-caption">'
             + '<h1>My Instagram collection</h1>'
             + '<p>If you like traveling and taking photos check my collection on Instagram. Nothing special, but you might enjoy some of the photos. It is not full of cats and dogs, I promise :)</p>'
             + '<p><a class="btn btn-lg btn-primary" href="https://www.instagram.com/sakiskasamp/">Check my Instagram</a></p>'
           + '</div>'
         + '</div>'
       + '</div>'
       + '<div class="item">'
